...
public class ArticlesServlet extends HttpServlet {
    ...
    private void showArticles(HttpServletRequest request,
        ...
        // BEGIN
        PagedList<Article> getPagedList = new QArticle()
                .setFirstRow(offset)
                .setMaxRows(articlesPerPage)
                .orderBy("id")
                .findPagedList();
        List<Article> articles = getPagedList.getList();
        // END
    ...
    private void createArticle(HttpServletRequest request,
        ...
        // BEGIN
        Category category = new QCategory().id.equalTo(Long.parseLong(categoryId)).findOne();
